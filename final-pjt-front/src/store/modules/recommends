  ...
  questions: [
    {
      ...
      answers: [
        { id: 1, label: '공원', image: 'park.png' },
        { id: 2, label: '바다', image: 'sea.png' },
        { id: 3, label: '집', image: 'home.png' }
      ]
    },
    {
      question: '어떤 날씨가 좋을까?',
      answers: [
        { id: 4, label: '햇빛 쨍쨍한 날', image: 'sun.png' },
        { id: 5, label: '비오는 날', image: 'rain.png' },
        { id: 6, label: '눈오는 날', image: 'snow.png' }
      ]
    },
    {
      question: '같이 먹고 싶은 음식은?',
      answers: [
        { id: 7, label: '팝콘', image: 'popcorn.png' },
        { id: 8, label: '치맥', image: 'chicken.png' },
        { id: 9, label: '와인과 치즈', image: 'wine.png' }
      ]
    }
  ],
...
const mutations = {
  ...
  RECOMMEND_LIST(state, payload) {
    state.recommendMovieList = payload.filter(movie => movie.poster_path)
  },
};
